  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative h-80 bg-gray-400 flex items-center justify-center text-white text-center mb-12!">
        ...
        />
        <h1 className="relative z-10 text-5xl! font-light!">
          {collectionName}
        </h1>
      </section>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    title="Like"
                    className="p-2! rounded-lg hover:text-red-600 cursor-pointer transition duration-200"
                  >
                    <Heart size={20} />
                  </button>
                  <button
                    title="Shop"
                    className="p-2! rounded-lg hover:text-blue-600 cursor-pointer transition duration-200"
                  >
                    <ShoppingBag size={20} />
                  </button>
                </div>
