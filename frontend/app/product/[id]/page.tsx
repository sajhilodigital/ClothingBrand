  ...
  return (
    <main className="bg-white">
      <div className="container mx-auto px-4 py-12">
        <Link href="/shop" className="text-sm text-gray-600 hover:text-gray-900 mb-8 flex items-center gap-1">
          ← Back to Shop
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          {/* Product Details */}
          <div>
            <h1 className="text-3xl font-light mb-2">{product.description}</h1>
            <p className="text-2xl text-orange-500 font-bold mb-4">NPR {product.price}</p>
            ...
            <div className="border-t-2 border-b-2 border-gray-300 py-4 mb-4">
              ...
              >
                SIZE CHART
                <ChevronDown size={20} className={`transition ${openSizeChart ? "rotate-180" : ""}`} />
              </button>
              {openSizeChart && (
            ...
            <div className="border-b-2 border-gray-300 py-4">
              ...
              >
                POLICY
                <ChevronDown size={20} className={`transition ${openPolicy ? "rotate-180" : ""}`} />
              </button>
              {openPolicy && (
                <div className="mt-4 text-sm text-gray-600">
                  <p className="mb-2">• 30-day returns on all items</p>
                  <p className="mb-2">• Items must be unworn and in original condition</p>
