...
export default function HeroSection() {
  return (
    <section className="bg-cream pt-12! pb-12! px-10! h-[80vh] flex items-center justify-center">
      <div className="max-w-7xl mx-auto! px-4! sm:px-6! lg:px-8!">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="flex flex-col gap-10">
            <div className="text-green-600 px-4! py-2! inline-block mb-8! w-fit text-sm! md:text-xl! lg:text-2xl! font-bold! tracking-wider">
              AUTUMN/WINTER 2025
            </div>
